...
// //   { id: 7, name: "Express.js", percent: 86, icon: <SiExpress /> },
// //   { id: 8, name: "MongoDB", percent: 88, icon: <FaDatabase /> },
// //   { id: 9, name: "Responsive", percent: 99, icon: <FaCss3Alt /> },
// //   { id: 10, name: "Sketch", percent: 86, icon: <FaSketch /> },
// // ];

// // export const Skill = () => {
// //   const ref = useRef(null);
// //   const isInView = useInView(ref, { once: true });
// //   const primaryColor = "#8750f7"; // Exact color from footer
...
// //           marginBottom: "12px",
// //           fontWeight: "bold",
// //           // Exact same gradient as Footer Md Shoaib logo
// //           background: `linear-gradient(90deg, #ffffff, ${primaryColor})`,
// //           WebkitBackgroundClip: "text",
// //           WebkitTextFillColor: "transparent",
// //         }}
// //         initial={{ opacity: 0, y: -20 }}
...
// //             whileHover={{
// //               scale: 1.05,
// //               boxShadow: `0 0 25px rgba(135, 80, 247, 0.4)`,
// //               border: `1px solid rgba(135, 80, 247, 0.5)`,
// //             }}
// //             style={{
...
//   const ref = useRef(null);
//   const isInView = useInView(ref, { once: true });
//   const primaryColor = "#8750f7"; // আপনার থিম পার্পল কালার
...
//         paddingTop: "120px",
//         paddingBottom: "120px",
//         background: "var(--tj-theme-accent-1)", // ব্যাকগ্রাউন্ড আগের মতোই আছে
//         color: "#fff",
//         fontFamily: "Segoe UI, sans-serif",
//         textAlign: "center",
//       }}
//     >
//       {/* My Skills Text Gradient - Exact Same as Footer Logo */}
//       <motion.h2
//         style={{
//           fontSize: "2.5rem",
//           marginBottom: "12px",
//           fontWeight: "bold",
//           display: "inline-block", // গ্রাডিয়েন্ট ঠিকভাবে পাওয়ার জন্য
//           background: `linear-gradient(90deg, #ffffff, ${primaryColor})`,
//           WebkitBackgroundClip: "text",
//           WebkitTextFillColor: "transparent",
//         }}
...
export const Skill = () => {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true });
  const primaryColor = "#8750f7"; // থিম পার্পল কালার
  ...
  return (
    <motion.section
      ...
      style={{
        paddingTop: "120px",
        paddingBottom: "120px",
        background: "linear-gradient(135deg, #030712 0%, #020617 40%, #030712 100%)", // Hero BG Added
        color: "#fff",
        fontFamily: "Segoe UI, sans-serif",
        textAlign: "center",
      }}
